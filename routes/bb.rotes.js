import { bhati, bilal, school, login, signup, getdatapass, upadeta, datea } from "../controller/test.controller.js"
...
inesf.route("/upatedadata/:id").post(authentication, upadeta)
